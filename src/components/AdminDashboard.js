...
import PolicyForm from './UserDashboardComponents/AddPolicy';
import AddDiscount from './UserDashboardComponents/AddDiscount';
    ...
    <div className={classes.root}>
      ...
      <div className={classes.content}>
        <div className={classes.leftColumn}>
         ...
         <div className={classes.text} onClick={() => handleCategoryClick('AddPolicy')}>
         <Typography variant="h6" className={classes.text}>
              <PolicyIcon className={classes.icon} />
              Add Policy
            </Typography>
         ...
         <div className={classes.text} onClick={() => handleCategoryClick('AddDiscount')}>
         <Typography variant="h6" className={classes.text}>
        ...
        <div className={classes.rightColumn}>
          ...
          {selectedCategory === 'AddPolicy' && (
           <PolicyForm/>
          )}
          {selectedCategory === 'AddDiscount' && (
           <AddDiscount/>
          )}
