      ...
      {policyData.length > 0 ? (
        <TableContainer component={Paper} className={classes.tableContainer}>
          <Table className={classes.table} aria-label="Policy Table">
            <TableHead>
              <TableRow>
                <TableCell className={classes.headerCell}>Policy ID</TableCell>
                <TableCell className={classes.headerCell}>Description</TableCell>
                <TableCell className={classes.headerCell}>Premium</TableCell>
                <TableCell className={classes.headerCell}>Coverage Amount</TableCell>
            ...
            <TableBody>
              {policyData.map((policy) => (
                <TableRow key={policy.policy_id}>
                  <TableCell className={classes.bodyCell}>{policy.policy_id}</TableCell>
                  <TableCell className={classes.bodyCell}>{policy.policy_description}</TableCell>
                  <TableCell className={classes.bodyCell}>{policy.standardPremium}</TableCell>
                  <TableCell className={classes.bodyCell}>{policy.coverageAmount}</TableCell>
                  <TableCell className={classes.bodyCell}>{policy.term}</TableCell>
                  <TableCell className={classes.bodyCell}>
                    <Button className={classes.button} onClick={() => handleBuyButtonClick(policy.policy_id)}>
                      Add to Cart
                    </Button>
                  </TableCell>
                </TableRow>
        ...
        <Typography variant="body1">Loading policies...</Typography>
      )}
    </div>
  );
};
